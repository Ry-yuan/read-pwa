<template>
  <div class="login-container">
    <mu-container class="demo-container is-stripe">
      <mu-row>
        <mu-col span="12">
          <div class="login-title">休闲一读Pwa登录</div>
        </mu-col>
      </mu-row>
    </mu-container>
    <!-- 表单 -->
    <mu-container>
      <mu-form ref="form" :model="validateForm" class="mu-demo-form" label-width="60px" label-position="left">
        <mu-row gutter>
        ...
        <mu-row gutter>
          <mu-col offset='6' span="6">
            <router-link class="login-span" to='/register'>没有账号？去注册</router-link>
          </mu-col>
        </mu-row>
        <mu-row gutter>
          <mu-col span="10">
